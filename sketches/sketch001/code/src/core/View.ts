...
export default class View {
    ...
    constructor(canvasElem: HTMLCanvasElement) {
        ...
        this.lineGridParameters = UTIL.initialzeLineGridParameters();

        // Setup: create a shape to add to the canvas
        this.shape = new Shape(
            this.two,
             this.lineGridParameters,
    ...
    public setupGUI(): void {
        ...
        this.lineGridParameters.gui_randomSeed = this.f2.add(
            this.shape.lineGridParameters, "randomSeed",
        ).name("randomSeed (int)")
        this.lineGridParameters.gui_orientation = this.f2.add(
            this.shape.lineGridParameters, "orientation",
            {
                Vertical: "vertical",
                Horizontal: "horizontal",
                Both: "both"
            },
        ).name("orientation (str)")
        this.lineGridParameters.gui_lineWidth = this.f2.add(
            this.shape.lineGridParameters, "lineWidth",
            this.lineGridParameters.lineWidth_min,
            this.lineGridParameters.lineWidth_max,
            this.lineGridParameters.lineWidth_step,
        ).name("lineWidth (mm)");
        this.lineGridParameters.gui_scaleNoise = this.f2.add(
            this.shape.lineGridParameters, "scaleNoise",
            this.lineGridParameters.scaleNoise_min,
            this.lineGridParameters.scaleNoise_max,
            this.lineGridParameters.scaleNoise_step,
        ).name("scaleNoise");
        this.lineGridParameters.gui_nLines = this.f2.add(
            this.shape.lineGridParameters, "nLines",
            this.lineGridParameters.nLines_min,
            this.lineGridParameters.nLines_max,
            this.lineGridParameters.nLines_step,
        ).name("nLines");
        this.lineGridParameters.gui_nPoints = this.f2.add(
            this.shape.lineGridParameters, "nPoints",
            this.lineGridParameters.nPoints_min,
            this.lineGridParameters.nPoints_max,
            this.lineGridParameters.nPoints_step,
        ).name("nPoints");
    ...
    private _randomize(): void {
        this.two.clear();
        this.setupSketch();
        this.shape.lineGridParameters.gui_randomSeed.setValue(
            this.rng.nextInt(0, 10000)
        )
        this.shape.lineGridParameters.gui_scaleNoise.setValue(
            this.shape.lineGridParameters.scaleNoise_max * this.rng.nextDouble(),
        )
        this.shape.draw();
    }
