...
export default class View {
    ...
    public setupGUI(): void {
        ...
        this.lineParameters.gui_terrainSize = this.f2.add(
            this.shape.lineParameters, "terrainSize",
            UTIL.terrainSizes,
        );


        this.lineParameters.gui_randomness = this.f2.add(
            this.shape.lineParameters, "randomness",
            this.lineParameters.randomness_min,
            this.lineParameters.randomness_max,
            this.lineParameters.randomness_step,
        ).name("randomness");


        this.lineParameters.gui_surface = this.f2.add(
            this.shape.lineParameters, "surface",
            this.lineParameters.surface_min,
            this.lineParameters.surface_max,
            this.lineParameters.surface_step,
        ).name("Surface level");

        this.lineParameters.gui_angle = this.f2.add(
            this.shape.lineParameters, "angle",
            this.lineParameters.angle_min,
            this.lineParameters.angle_max,
            this.lineParameters.angle_step,
        ).name("Angle");
    ...
    private _randomize(): void {
        ...
        this.shape.lineParameters.gui_randomSeed.setValue(
