...
export interface LineParameters {
    ...
    gui_terrainSize: DAT.GUIController;
    terrainSize: number;


    gui_randomness: DAT.GUIController;
    randomness: number;
    randomness_min: number;
    randomness_max: number;
    randomness_step: number;

    gui_surface: DAT.GUIController;
    surface_min: number;
    surface_max: number;
    surface_step: number;
    surface: number;
...
export function initialzeLineParameters(): LineParameters {
    let lineParameters = {
        ...
        "gui_terrainSize": undefined,
        "terrainSize": 512,

        "gui_randomness": undefined,
        "randomness_min": 10,
        "randomness_max": 1000,
        "randomness_step": 1,
        "randomness": 50,

        "gui_surface": undefined,
        "surface_min": 0,
        "surface_max": 100,
        "surface_step": 1,
        "surface": 10,
...
// Define different terrain sizes
export const terrainSizes: Record<string, number>  = {
    32: 32,
    64: 64,
    128: 128,
    256: 256,
