...
export default class View {
    ...
    public setupGUI(): void {
        ...
        // Folder f2: Shape parameters
        this.shapeParameters.gui_lineWidth = this.f2.add(
            this.shape.shapeParameters, "lineWidth",
            this.shapeParameters.lineWidth_min,
            this.shapeParameters.lineWidth_max,
            this.shapeParameters.lineWidth_step,
        ).name("lineWidth (mm)");

        this.shapeParameters.gui_shapeType = this.f2.add(
            this.shape.shapeParameters, "shapeType",
            {Hypotrochoid: 0, Epitrochoid: 1}, // Choices
        );

        this.shapeParameters.gui_radiusOne = this.f2.add(
            this.shape.shapeParameters, "radiusOne",
            this.shapeParameters.radiusOne_min, this.shapeParameters.radiusOne_max,
            this.shapeParameters.radiusOne_step,
        ).name("radiusOne");

        this.shapeParameters.gui_radiusTwo = this.f2.add(
            this.shape.shapeParameters, "radiusTwo",
            this.shapeParameters.radiusTwo_min, this.shapeParameters.radiusTwo_max,
            this.shapeParameters.radiusTwo_step,
        ).name("radiusTwo");

        this.shapeParameters.gui_distance = this.f2.add(
            this.shape.shapeParameters, "distance",
            this.shapeParameters.distance_min, this.shapeParameters.distance_max,
            this.shapeParameters.distance_step,
        ).name("distance");

        this.shapeParameters.gui_segmentMultiplier = this.f2.add(
            this.shape.shapeParameters, "segmentMultiplier",
        ...
        this.shapeParameters.gui_nPoints = this.f2.add(
            this.shape.shapeParameters, "nPoints",
            this.shapeParameters.nPoints_min,
            this.shapeParameters.nPoints_max,
            this.shapeParameters.nPoints_step,
        ).name("nPoints");
    ...
    private _randomize(): void {
        ...
        this.shapeParameters.gui_shapeType.setValue(
            Math.round(this.rng.nextDouble()),
        )
        this.shapeParameters.gui_radiusOne.setValue(
            this.shapeParameters.radiusOne_max * this.rng.nextDouble(),
        );
        this.shapeParameters.gui_radiusTwo.setValue(
            this.shapeParameters.radiusTwo_max * this.rng.nextDouble(),
        );
        this.shapeParameters.gui_distance.setValue(
            this.shapeParameters.distance_max * this.rng.nextDouble(),
        );
